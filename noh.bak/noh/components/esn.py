from noh_.activate_functions import linear
from noh_.training_functions import gen_linear_regression_trainer

from noh.components import Layer, Reservoir
from noh_ import Circuit, PropRule, TrainRule, Planner
